...
/**
 * Servlet implementation class ProductListShowByPriceRange
 */
@WebServlet("/getPrd/priceRange")
public class ProductListShowByPriceRange extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int range = (rangeString != null) ? Integer.parseInt(rangeString) : 0;

		ShopGridService shopGridService = new ShopGridService();

		ArrayList<ProductListData> productListDatads = shopGridService.getProductListByPriceRange(range, sort, page);
		int totalRow = shopGridService.getCountFromPriceRange(range);
